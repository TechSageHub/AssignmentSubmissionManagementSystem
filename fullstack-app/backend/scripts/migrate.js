...
const migrations = dbType === 'postgres'
  ? [
      ...
      'migration_022_add_grade_appeals.postgres.sql',
      'migration_023_add_perf_indexes.postgres.sql',
    ]
  : [
      ...
      'migration_022_add_grade_appeals.sql',
      'migration_023_add_perf_indexes.sql',
    ];
